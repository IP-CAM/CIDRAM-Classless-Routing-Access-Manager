 ...
 * @return void
 */
$CIDRAM['DNS-Reverse-Forward'] = function ($Domains, string $Friendly, array $Options = []) use (&$CIDRAM): void {
    /** Fetch the hostname. */
 ...
 */
$CIDRAM['IsSensitive'] = function (string $URI) use (&$CIDRAM): bool {
 ...
 */
$CIDRAM['isReserved'] = function (string $Name): bool {
